...
import App from "./components/quiz-components/App/index";
...
const HomeLayout = ({ children }) => {
    const loadBazIfNeeded = async () => {
        if (children = 'App') {
            console.log("app");
        }
    };

    // Call the loadBazIfNeeded function to conditionally import and use Baz
...
const router = createBrowserRouter([
    ...
    },
    {
        ...
        element: (
            <HomeLayout>
                <PrivateRoute path="/home/collection" element={<Collection />} />
            </HomeLayout>
        )
    },
    {
        ...
        element: (
            <HomeLayout>
               <PrivateRoute path="/home/userquiz" element={<App />} />
