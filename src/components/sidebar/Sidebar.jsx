        ...
        <>
            <div class="relative hidden h-screen my-4 ml-4  lg:block w-72 ">
                <div class="h-full bg-transparent rounded-2xl dark:bg-gray-700">
                    <a href='/' class="flex items-center justify-center pt-6">
                        ...
                        <div class="pl-6">
                            ...
                            {role == '[ROLE_USER]' && (
                                <>
                                    ...
                                    <a class={`${currentPath === '/home/userquiz' ? 'text-lime-500' : ''} flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 hover:text-lime-500`} href="/home/userquiz">
                                        <div className='flex justify-start'>
